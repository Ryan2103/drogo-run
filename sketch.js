...
var jumpSound,shoot,end
var plant,plantImg,plantGroup
var plant1,plant1img,plant1group
var lifeSound,startSound,soundback
...
sImg=loadImage("images/rules.PNG")
...
enemy=createSprite(1150,320,20,20)
...
life3.visible=true
    ...
    boy.changeAnimation("boyImg1",boyImg1)
      ...
      if(count>100&&count<2000 || count>2500){
    //a.visible=true  
    enemy.visible=true
    if(count==1970){
    ...
    if(count>2400){
      enemy.changeAnimation("enemy",enemyImg)
    }

if(frameCount%42==0){
 // if(enemy.image="images/e5.png"){
    //laser.visible=true
    laser=createSprite(1100,320,20,20)
    laser.addImage("l",laserImg)
    laser.scale=0.1
    laser.velocityX=-15
    laser.lifetime
...
function spawnPlant(){
  if(frameCount%500==0){
    plant=createSprite(1250,350,20,20)
...
function spawnPlant1(){
  if(frameCount%700==0){
    plant1=createSprite(1200,350,20,20)
    plant1.addImage("plant1",plant1img)
    plant1group.add(plant1)
    plant1.velocityX=-2
    plant1.scale=0.5
  }
